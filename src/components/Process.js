...
const Process = ({ pid,jobid, releaseTime, executionTime, color,parWidth }) => {
  ...
  const style = {
    ...
    position: 'absolute',
    textAlign: 'center',
    width: `${executionTime * parWidth}px`, // Adjust width based on burst time
    left: `${releaseTime * parWidth}px`, // Adjust position based on arrival time
